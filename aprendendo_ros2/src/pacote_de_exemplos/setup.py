...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'mapping = pacote_de_exemplos.mapping:main',
            'mappingTest = pacote_de_exemplos.mappingTest:main',
            'mappingContinuing = pacote_de_exemplos.mappingContinuing:main',
            'lidar_to_grid_map = pacote_de_exemplos.lidar_to_grid_map:main'
